...
class _DateSuggestionsScreenState extends State<DateSuggestionsScreen> {
  ...
  final List<DateSuggestion> _suggestions = [
    DateSuggestion(
    ...
    DateSuggestion(
      ...
      imageUrl:
          'assets/cinema_casa.jpg', // Adicione esta imagem aos seus assets
    ),
    DateSuggestion(
    ...
    DateSuggestion(
      ...
      imageUrl:
          'assets/cidade_nova.jpg', // Adicione esta imagem aos seus assets
    ),
    DateSuggestion(
