...
import 'package:myapp/src/add_special_date_screen.dart'; // Importa a tela de adicionar data especial
...
class _MainAppScreenState extends State<MainAppScreen> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient( // Degradê de fundo da barra
            colors: <Color>[Color(0xFFFF6B81), Color(0xFFA084E8)],
            begin: Alignment.topCenter,
            end: Alignment.bottomCenter,
          ),
          borderRadius: BorderRadius.vertical(top: Radius.circular(25)), // Borda arredondada no topo
          boxShadow: [ // Sombra para a barra
            BoxShadow(
        ...
        child: Row( // Linha de ícones na barra
          mainAxisAlignment: MainAxisAlignment.spaceAround, // Espaçamento uniforme entre os ícones
          children: [
            // Itens da barra de navegação, com seus respectivos índices e ícones
            _buildNavBarItem(0, Icons.date_range), // Índice 0: Ícone de Data (antiga lupa)
  ...
  Widget _buildNavBarItem(int index, IconData icon) {
    final bool isSelected = _selectedIndex == index; // Verifica se o item está selecionado
    return GestureDetector(
      onTap: () => _onItemTapped(index), // Ao tocar, chama a função para mudar a tela
      child: Column(
        mainAxisSize: MainAxisSize.min, // Ocupa o mínimo de espaço vertical necessário
        mainAxisAlignment: MainAxisAlignment.center, // Centraliza o ícone verticalmente
        children: [
          Icon(
            icon,
            color: isSelected ? Colors.white : Colors.white.withOpacity(0.7), // Cor diferente para o item selecionado
            size: 30,
          ),
