...
import 'package:percent_indicator/percent_indicator.dart'; // Importe o percent_indicator aqui também
...
class _HomeScreenState extends State<HomeScreen> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // REMOVIDO: Calculadora de Amor (Coração Pixelado)
                      // _buildPixelHeartProgress(0.50),
                      // const SizedBox(height: 20),
                      // const Text(
                      //   'Conexão do Casal',
  ...
  // REMOVIDO: Widget auxiliar para a calculadora de amor (coração pixelado)
  // Widget _buildPixelHeartProgress(double progress) {
  //   return SizedBox(
  //     width: 150,
  //     height: 150,
  //     child: Stack(
  ...
  //       children: [
  //         Image.asset(
  //           'assets/heart_empty_pixel.png',
  //           color: Colors.red[100],
  //           fit: BoxFit.contain,
  //           errorBuilder: (context, error, stackTrace) {
  //             return Icon(Icons.favorite_border, size: 150, color: Colors.red[100]);
  //           },
  //         ),
  //         ClipRect(
  //           child: Align(
  ...
  //             child: Image.asset(
  //               'assets/heart_full_pixel.png',
  //               color: Colors.red,
  //               fit: BoxFit.contain,
  //               errorBuilder: (context, error, stackTrace) {
  //                 return Icon(Icons.favorite, size: 150, color: Colors.red);
  //               },
  //             ),
  //           ),
  //         ),
